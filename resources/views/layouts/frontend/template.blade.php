...
<head>
    ...
    <script>
        ...
        if (themeName) {
            ...
            document.write('<link rel="stylesheet" id="theme-style" href="/modular-admin/css/app-blue.css">');
        }
    </script>
    @stack('styles')
</head>
<body>
<div class="auth" style="background-image: url('/img/bg1.jpg'); background-repeat: no-repeat; background-size: cover;">
